...
dotnet ../tools/sonar/SonarScanner.MSBuild.dll begin /o:"marcin-golebiowski" /k:"SpiceSharpParser" /d:sonar.cs.vstest.reportsPaths="Tests.trx;IntegrationTests.trx" /d:sonar.host.url="https://sonarcloud.io" /d:sonar.verbose=true /d:sonar.login=${SONAR_TOKEN}
echo "Running build..."
...
echo "Running tests..."
dotnet test SpiceSharpParser.Tests/SpiceSharpParser.Tests.csproj --logger:trx "trx;LogFileName=Tests.trx"
