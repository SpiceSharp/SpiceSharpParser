...
- **Structure**: [.SUBCKT](articles/subckt.md), [X (Subcircuit Instance)](articles/subcircuit-instance.md), [Programmatic Subcircuit Libraries](articles/subcircuit-library.md), [Digital Gate Subcircuit Library](articles/digital-subcircuits.md), [.INCLUDE](articles/include.md), [.LIB](articles/lib.md), [.GLOBAL](articles/global.md), [.APPENDMODEL](articles/appendmodel.md)
