...
namespace SpiceNetlist.SpiceSharpConnector.Tests.Context
{
    public class NodeNameGeneratorTest
    {
        ...
        {
            var subcircuit = new SpiceObjects.SubCircuit();
            subcircuit.Pins = new System.Collections.Generic.List<string>() { "IN", "OUT" };
            subcircuit.DefaultParameters =
                new System.Collections.Generic.List<SpiceObjects.Parameters.AssignmentParameter>() {
                    new SpiceObjects.Parameters.AssignmentParameter() { Name = "L", Value = "100" },
                    new SpiceObjects.Parameters.AssignmentParameter() { Name = "C", Value = "10" } };
