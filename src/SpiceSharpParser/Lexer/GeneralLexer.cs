...
namespace SpiceSharpParser.Lexer
{
    ...
    public class GeneralLexer<TLexerState>
        where TLexerState : LexerState
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralLexer{TLexerState}"/> class.
        /// </summary>
        /// <param name="grammar">Lexer grammar</param>
        /// <param name="options">Lexer options</param>
        public GeneralLexer(LexerGrammar<TLexerState> grammar, LexerOptions options)
        {
            Options = options;
