...
namespace SpiceSharpParser.ModelReader.Spice.Processors
{
    ...
    /// </summary>
    public class ModelProcessor : StatementProcessor<SpiceSharpParser.Model.Spice.Objects.Model>, IModelProcessor
    {
        /// <summary>
        ...
        public override void Process(SpiceSharpParser.Model.Spice.Objects.Model statement, IProcessingContext context)
        {
