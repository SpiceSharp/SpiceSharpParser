...
namespace SpiceSharpParser.ModelReader.Spice.Processors.EntityGenerators.Components
{
    /// <summary>
    ...
    public class SubCircuitGenerator : EntityGenerator
    {
        ...
        {
            foreach (Statement statement in subCircuitDefiniton.Statements.Where(s => s is Model.Spice.Objects.Model))
            {
                modelProcessor.Process((Model.Spice.Objects.Model)statement, subCircuitContext);
            }
        }
