...
{
    /// <summary>
    /// A result of reading a Spice model.
    /// </summary>
    public class SpiceModelReaderResult
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpiceModelReaderResult"/> class.
        /// </summary>
        /// <param name="circuit">The SpiceSharp circuit for the netlist.</param>
        /// <param name="title">The title of the netlist.</param>
        public SpiceModelReaderResult(Circuit circuit, string title)
        {
            Circuit = circuit;
            Title = title;
        }
