...
namespace SpiceSharpParser.ModelReader.Netlist.Spice.Processors.Controls.Simulations
{
    ...
    public abstract class SimulationControl : BaseControl
    {
        ...
        private void CreateSimulationsForAllParameterSweepsAndTemperatures(Control statement, IProcessingContext context, Func<string, Control, IProcessingContext, BaseSimulation> createSimulation)
        {
            ...
            for (var i = 0; i < productCount; i++)
            {
                ...
                Func<string, Control, IProcessingContext, BaseSimulation> modifiedCreateSimulation =
                    ...
                    {
                        List<KeyValuePair<Model.Netlist.Spice.Objects.Parameter, double>> parameterValues = GetSweepParameterValues(context, sweeps, system, indexes);
        ...
        private void SetSimulation(IProcessingContext context, List<KeyValuePair<Model.Netlist.Spice.Objects.Parameter, double>> parameterValues, BaseSimulation simulation)
        {
        ...
        private void UpdateDeviceParameter(IProcessingContext context, KeyValuePair<Model.Netlist.Spice.Objects.Parameter, double> paramToSet, ReferenceParameter rp)
        {
        ...
        private static void UpdateModelParameter(IProcessingContext context, KeyValuePair<Model.Netlist.Spice.Objects.Parameter, double> paramToSet, BracketParameter bp)
        {
        ...
        private void UpdateSimulationParameter(IProcessingContext context, KeyValuePair<Model.Netlist.Spice.Objects.Parameter, double> paramToSet)
        {
        ...
        private List<KeyValuePair<Model.Netlist.Spice.Objects.Parameter, double>> GetSweepParameterValues(IProcessingContext context, List<List<double>> sweeps, int[] system, int[] indexes)
        {
            ...
            {
                Model.Netlist.Spice.Objects.Parameter parameter = context.Result.SimulationConfiguration.ParameterSweeps[j].Parameter;

                double parameterValue = sweeps[j][indexes[j]];
                parameterValues.Add(new KeyValuePair<Model.Netlist.Spice.Objects.Parameter, double>(parameter, parameterValue));
