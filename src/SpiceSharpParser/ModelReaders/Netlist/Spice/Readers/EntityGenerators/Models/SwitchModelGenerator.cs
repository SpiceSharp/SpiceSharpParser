        ...
        public override Context.Models.Model Generate(string id, string type, ParameterCollection parameters, IReadingContext context)
        {
            switch (type.ToLower())
            {
                case "sw":
                    ...
                    SetParameters(context, vsModel, vsContextModel, parameters, type);
                ...
                case "csw":
                    ...
                    SetParameters(context, csModel, csContextModel, parameters, type);
                ...
                case "vswitch":
                    ...
                    SetParameters(context, vSwitchModel, vSwitchContextModel, parameters, type);
                ...
                case "iswitch":
                    ...
                    SetParameters(context, iSwitchModel, iSwitchContextModel, parameters, type);
