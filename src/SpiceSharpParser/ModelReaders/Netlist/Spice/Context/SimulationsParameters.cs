...
namespace SpiceSharpParser.ModelReaders.Netlist.Spice.Context
{
    ...
    public class SimulationsParameters : ISimulationsParameters
    {
        ...
        public EventHandler<SimulationEventArgs> SimulationCreated { get; set; }

        public ISimulationEvaluators Evaluators { get; }
        ...
        public void SetParameter(Entity @object, string paramName, double value, int order)
        {
            SimulationCreated += (object sender, SimulationEventArgs args) =>
            {
                UpdateParameterBeforeLoad(paramName, @object, value.ToString(), args.Simulation, order);
                UpdateParameterBeforeTemperature(paramName, @object, value.ToString(), args.Simulation, order);
            };
        }
        ...
        public void SetParameter(Entity @object, string paramName, double value, BaseSimulation simulation, int order)
        {
            ...
            UpdateParameterBeforeLoad(paramName, @object, value.ToString(), simulation, order);
            UpdateParameterBeforeTemperature(paramName, @object, value.ToString(), simulation, order);
        }
