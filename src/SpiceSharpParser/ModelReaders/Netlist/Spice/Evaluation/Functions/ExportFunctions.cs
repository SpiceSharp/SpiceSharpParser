...
namespace SpiceSharpParser.ModelReaders.Netlist.Spice.Evaluation.Functions
{
    public class ExportFunctions
    {
        ...
        public static IEnumerable<KeyValuePair<string, Function>> Create(IMapper<Exporter> exporterRegistry,
            ...
            IObjectNameGenerator modelNameGenerator, IResultService resultService, CaseSensitivitySettings caseSettings)
        {
        ...
        public static Function CreateOrdinaryExport(Dictionary<string, Readers.Controls.Exporters.Export> exporters,
            ...
            CaseSensitivitySettings caseSensitivity)
        {
        ...
        public static Function CreateAtExport(Dictionary<string, Export> exporters, Exporter exporter,
            ...
            IObjectNameGenerator modelNameGenerator, IResultService result, CaseSensitivitySettings caseSettings)
        {
            Function function = new Function();
            function.VirtualParameters = true;
