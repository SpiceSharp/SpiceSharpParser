...
`SpiceSharpMechanical2D` adds smooth, two-dimensional mechanical components to
...
```powershell
dotnet run --project samples/SpiceSharpMechanical2D.Samples/Learning/02CoordinateCoasting
```
...
dotnet run --project samples/SpiceSharpMechanical2D.Samples/Learning/08RevolutePendulum
```

The complete learning path is described in the
[samples README](../../samples/SpiceSharpMechanical2D.Samples/Learning/README.md).
...
```xml
<ItemGroup>
  <ProjectReference Include="path/to/SpiceSharpMechanical2D.csproj" />
</ItemGroup>
```
...
- [Getting-started tutorial](../../docs/tutorials/spicesharp-mechanical2d-getting-started.md)
- [Numbered learning samples](../../samples/SpiceSharpMechanical2D.Samples/Learning/README.md)
- [Feature gallery](../../samples/SpiceSharpMechanical2D.Samples/FeatureGallery/README.md)
- [Standalone samples](../../samples/SpiceSharpMechanical2D.Samples/README.md)
