...
using SpiceSharpParser.Connector.Processors.EntityGenerators.Components.Sources;
using SpiceSharpParser.Model.SpiceObjects;
using SpiceSharpParser.Model.SpiceObjects.Parameters;
using SpiceSharp.Components;
using Xunit;

namespace SpiceSharpParser.Tests.Connector.Processors.EntityGenerators.Components.Sources
{
    public class CurrentSourceGeneratorTest
    {
        ...
        {
            var waveformProcessor = Substitute.For<IWaveformProcessor>();

            var sine = new Sine();
            waveformProcessor.Generate(
                Arg.Any<BracketParameter>(), 
                Arg.Any<IProcessingContext>()).Returns(
               sine);

            var generator = new CurrentSourceGenerator(waveformProcessor);
