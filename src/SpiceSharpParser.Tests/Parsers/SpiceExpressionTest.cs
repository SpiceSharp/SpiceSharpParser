...
namespace SpiceSharpParser.Tests.Parsers
{
    public class SpiceExpressionTest
    {
        ...
        public void ParseWitKnownParameter()
        {
            // arrange
            var parser = new SpiceExpressionParser();
            parser.Parameters["x"] = new Common.Evaluation.CachedExpression((e, c, a) => 1);
        ...
        public void ParseConditional()
        {
            ...
            // act and assert
            parser.Parameters["TEMP"] = new Common.Evaluation.CachedExpression((e, c, a) => 26);
            Assert.Equal(2.52e-9, parser.Parse("TEMP == 26 ? 2.52e-9 : 2.24e-9").Value());

            parser.Parameters["TEMP"] = new Common.Evaluation.CachedExpression((e, c, a) => 27);
