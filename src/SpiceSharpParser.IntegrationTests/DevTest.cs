...
namespace SpiceSharpParser.IntegrationTests
{
    public class DevTest : BaseTest
    {
        ...
        [Fact]
        public void DevMultipleComponentsSameModelMosfetTest()
        {
            var netlist = ParseNetlist(
                "Mosfet circuit",
                "Md d g 0 0 my-nmos",
        ...
        [Fact]
        public void DevNonZeroConstantWithExpressionTest()
        {
            int randomSeed = 1234;
            var netlist = ParseNetlist(
                randomSeed,
            ...
            double[] references =
            {
                2.2949464550947596E-09,
                2.2947399536121793E-09,
                2.2944726119078496E-09,
                2.2940966903917115E-09,
                2.2935049415195863E-09,
                2.2924376841260141E-09,
                2.2901496254945641E-09,
                2.2839052871148624E-09,
                2.258563669421676E-09,
                2.0418530199961538E-09,
                8.55367984256033E-33,
                -1.8553060199266724E-08,
                -1.8713947180781787E-07,
                -1.7190139993683573E-06,
                -1.5636127969398395E-05,
                -0.00014187595413317489,
                -0.0012710947939227335,
                -0.010312614688099631,
                -0.054115833974556882,
                -0.14924181911736145,
                -0.27619229318348237
            };
        ...
        [Fact]
        public void DevNonZeroConstantTest()
        {
            int randomSeed = 1234;
            var netlist = ParseNetlist(
                randomSeed,
        ...
        [Fact]
        public void DevNonZeroParamTest()
        {
            int randomSeed = 1234;
            var netlist = ParseNetlist(
                randomSeed,
