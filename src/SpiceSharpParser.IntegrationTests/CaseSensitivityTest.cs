...
namespace SpiceSharpParser.IntegrationTests
{
    public class CaseSensitivityTest : BaseTest
    {
        ...
        public void DotStatementsExceptionTest()
        {
            ...
            parser.Settings.CaseSensitivity.IsDotStatementCaseSensitive = true;
        ...
        [Fact]
        public void FunctionNamePositiveTest()
        {
            var parser = new SpiceParser();

            parser.Settings.Parsing.HasTitle = true;
            parser.Settings.Parsing.IsEndRequired = true;
            parser.Settings.CaseSensitivity.IsFunctionNameCaseSensitive = false;
        ...
        [Fact]
        public void FunctionNameNotFoundTest()
        {
            var parser = new SpiceParser();

            parser.Settings.Parsing.HasTitle = true;
            parser.Settings.Parsing.IsEndRequired = true;
            parser.Settings.CaseSensitivity.IsFunctionNameCaseSensitive = true;
        ...
        public void DotStatementsNoException2Test()
        {
            ...
            parser.Settings.CaseSensitivity.IsDotStatementCaseSensitive = false;
        ...
        public void NodeNamesPositiveTest()
        {
            ...
            parser.Settings.Parsing.HasTitle = true;
            parser.Settings.Parsing.IsEndRequired = true;
            parser.Settings.CaseSensitivity.IsNodeNameCaseSensitive = false;
        ...
        public void NodeNamesNegativeTest()
        {
            ...
            parser.Settings.Parsing.HasTitle = true;
            parser.Settings.Parsing.IsEndRequired = true;
            parser.Settings.CaseSensitivity.IsNodeNameCaseSensitive = true;
            ...
            var parseResult = parser.ParseNetlist(text);
            Assert.Throws<GeneralReaderException>(() => RunOpSimulation(parseResult.SpiceSharpModel, "V(Out)"));
        }
        ...
        [Fact]
        public void ComponentNamesPositiveTest()
        {
            var parser = new SpiceParser();

            parser.Settings.Parsing.HasTitle = true;
            parser.Settings.Parsing.IsEndRequired = true;
            parser.Settings.CaseSensitivity.IsEntityNameCaseSensitive = false;
        ...
        [Fact]
        public void ComponentNamesExceptionTest()
        {
            var parser = new SpiceParser();

            parser.Settings.Parsing.HasTitle = true;
            parser.Settings.Parsing.IsEndRequired = true;
            parser.Settings.CaseSensitivity.IsEntityNameCaseSensitive = true;
        ...
        [Fact]
        public void ModelNamesPositiveTest()
        {
            var parser = new SpiceParser();
        ...
        [Fact]
        public void ParamNamesPositiveTest()
        {
            var parser = new SpiceParser();

            parser.Settings.Parsing.HasTitle = true;
            parser.Settings.Parsing.IsEndRequired = true;
            parser.Settings.CaseSensitivity.IsParameterNameCaseSensitive = false;
        ...
        [Fact]
        public void ParamNamesFunctionParamPositiveTest()
        {
            var parser = new SpiceParser();
        ...
        [Fact]
        public void ParamNamesExceptionTest()
        {
            var parser = new SpiceParser();

            parser.Settings.Parsing.HasTitle = true;
            parser.Settings.Parsing.IsEndRequired = true;
            parser.Settings.CaseSensitivity.IsParameterNameCaseSensitive = true;
        ...
        [Fact]
        public void LetNamePositiveTest()
        {
            var parser = new SpiceParser();

            parser.Settings.Parsing.HasTitle = true;
            parser.Settings.Parsing.IsEndRequired = true;
            parser.Settings.CaseSensitivity.IsLetExpressionNameCaseSensitive = false;
        ...
        [Fact]
        public void LetNameExceptionTest()
        {
            var parser = new SpiceParser();

            parser.Settings.Parsing.HasTitle = true;
            parser.Settings.Parsing.IsEndRequired = true;
            parser.Settings.CaseSensitivity.IsLetExpressionNameCaseSensitive = true;
        ...
        [Fact]
        public void EntityParameterPositiveTest()
        {
            var parser = new SpiceParser();

            parser.Settings.Parsing.HasTitle = true;
            parser.Settings.Parsing.IsEndRequired = true;
            parser.Settings.CaseSensitivity.IsEntityParameterNameCaseSensitive = false;
        ...
        [Fact]
        public void EntityParameterPositive2Test()
        {
            var parser = new SpiceParser();
        ...
        [Fact]
        public void EntityParameterPositive3Test()
        {
            var parser = new SpiceParser();
        ...
        [Fact]
        public void EntityParameterException3Test()
        {
            var parser = new SpiceParser();

            parser.Settings.Parsing.HasTitle = true;
            parser.Settings.Parsing.IsEndRequired = true;
            parser.Settings.CaseSensitivity.IsEntityParameterNameCaseSensitive = true;
            ...
            var parseResult = parser.ParseNetlist(text);
            Assert.Throws<GeneralReaderException>(() => RunDCSimulation(parseResult.SpiceSharpModel, "@V1[I]"));
        }

        [Fact]
        public void EntityParameterExceptionTest()
        {
            var parser = new SpiceParser();
