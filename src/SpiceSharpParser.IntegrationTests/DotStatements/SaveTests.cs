...
namespace SpiceSharpParser.IntegrationTests.DotStatements
{
    public class SaveTests : BaseTests
    {
        ...
        public void SpaceInExport()
        {
            ...
            double[] export = RunOpSimulation(model, "V(OUT,0)", "I(X1.R1)");
        ...
        [Fact]
        public void SaveWithoutParameters()
        {
            var model = GetSpiceSharpModel(
                "Save -Low-pass RC circuit - The capacitor should act like an open circuit",
                "V1 IN 0 10.0",
                "R1 IN OUT 10e3",
                "C1 OUT 0 10e-6",
                ".OP",
            ...
            var exports = RunOpSimulation(model);
            Assert.Equal(6, exports.Length);
        }

        [Fact]
        public void SaveWithoutParametersComplex()
        {
            var model = GetSpiceSharpModel(
                "Save - Subcircuit - ComplexSubcircuitWithParams",
                "V1 IN 0 4.0",
        ...
        {
            var model = GetSpiceSharpModel(
                "Save - Lowpass RC circuit - The capacitor should act like an open circuit",
                "V1 IN 0 10.0",
                "R1 IN OUT 10e3",
                "C1 OUT 0 10e-6",
                ".OP",
        ...
        [Fact]
        public void SaveWithFilterDCBasic()
        {
            var model = GetSpiceSharpModel(
               "Save - Diode circuit",
               "D1 OUT 0 1N914",
        ...
        public void SaveDCFromLetAdvanced() //TODO: Better test names :(
        {
            ...
            var export = RunDCSimulation(model, "xxy");

            Assert.Equal(201, export.Length);
        }

        [Fact]
        public void SaveWithFilterMultiple()
        {
            var model = GetSpiceSharpModel(
               "Save - Diode circuit",
               "D1 OUT 0 1N914",
            ...
            Assert.True(EqualsWithTol((List<double>)exports[0], dc_references));
            Assert.True(EqualsWithTol((List<double>)exports[1], dc_references));
        ...
        [Fact]
        public void SaveWithoutFilterMultiple()
        {
            var model = GetSpiceSharpModel(
               "Save - Diode circuit",
               "D1 OUT 0 1N914",
        ...
        [Fact]
        public void VoltageInternalNodeInSubcircuit()
        {
            var model = GetSpiceSharpModel(
                "Save - Subcircuit test",
                "V1 IN 0 4.0",
            ...
            double[] export = RunOpSimulation(model, "V(OUT)", "V(X1.1)");
        ...
        public void CurrentInSubcircuit()
        {
            ...
            double[] export = RunOpSimulation(model, "V(OUT)", "I(X1.R1)");
        ...
        [Fact]
        public void VoltagePublicNodeInSubcircuit()
        {
            var model = GetSpiceSharpModel(
                "Save - Subcircuit test",
                "V1 IN 0 4.0",
            ...
            double[] export = RunOpSimulation(model, "V(OUT)", "V(X1.input)");
        ...
        [Fact]
        public void VoltagePublicNodeInNestedSubcircuit()
        {
            var model = GetSpiceSharpModel(
                "Save - Subcircuit test",
                "V1 IN 0 4.0",
            ...
            double[] export = RunOpSimulation(model, "V(OUT)", "V(X1.X1.input)");
        ...
        public void CurrentInNestedSubcircuit()
        {
            ...
            double[] export = RunOpSimulation(model, "V(OUT)", "I(X1.X1.R1)");
        ...
        [Fact]
        public void VoltageExtremeNodeInNestedSubcircuit()
        {
            var model = GetSpiceSharpModel(
                "Save - Subcircuit test",
                "V1 IN 0 4.0",
            ...
            double[] exports = RunOpSimulation(model, "V(IN)", "V(X1.input)", "V(X1.output)", "V(X1.1)", "V(X1.X1.input)", "V(X1.X1.output)", "V(X1.X1.1)");

            Assert.True(EqualsWithTol(exports, new double[] { 4, 4, 0, 2, 4, 2, 3 }));
        }
        ...
        public void CurrentInExtremeNestedSubcircuit()
        {
            ...
            double[] exports = RunOpSimulation(model, "V(IN)", "I(X1.X1.X1.R1)");

            Assert.True(EqualsWithTol(exports, new double[] { 4, 1 }));
        }
        ...
        public void CurrentByAmpersandInNestedSubcircuit()
        {
            ...
            double[] export = RunOpSimulation(model, "V(OUT)", "@X1.X1.R1[i]");
