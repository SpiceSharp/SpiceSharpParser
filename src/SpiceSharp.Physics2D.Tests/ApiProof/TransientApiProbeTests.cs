...
using SpiceSharp.Physics2D.ApiProbe;
...
namespace SpiceSharp.Physics2D.Tests.ApiProof
{
    public class TransientApiProbeTests
    {
        ...
        public void ImplementationSourceDoesNotUsePrivateReflection()
        {
            ...
            string implementationRoot = Path.Combine(sourceRoot, "SpiceSharp.Physics2D");
            var files = Directory
