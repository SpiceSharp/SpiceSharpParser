# Getting started with SpiceSharpMechanical2D
...
`SpiceSharpMechanical2D` expresses mechanical differential equations as
...
```powershell
dotnet run --project samples/SpiceSharpMechanical2D.Samples/SliderCrank
dotnet run --project samples/SpiceSharpMechanical2D.Samples/CompliantFourBar
```

The [Feature Gallery](../../samples/SpiceSharpMechanical2D.Samples/FeatureGallery/README.md)
