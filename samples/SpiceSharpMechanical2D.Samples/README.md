...
[project README](../../src/SpiceSharpMechanical2D/README.md), then follow the
...
dotnet run --project samples/SpiceSharpMechanical2D.Samples/FeatureGallery -- point-force
