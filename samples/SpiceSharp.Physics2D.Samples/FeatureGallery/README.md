# SpiceSharp.Physics2D feature gallery
...
```powershell
dotnet run --project samples/SpiceSharp.Physics2D.Samples/FeatureGallery -- projectile
dotnet run --project samples/SpiceSharp.Physics2D.Samples/FeatureGallery -- two-body-spring
dotnet run --project samples/SpiceSharp.Physics2D.Samples/FeatureGallery -- prismatic-slider
```
...
dotnet run --project samples/SpiceSharp.Physics2D.Samples/FeatureGallery -- smoke
```
